...
const styles = StyleSheet.create({
  ...
  promptWrapper: { position: 'relative', width: canvasSize, marginBottom: 12 },
  ...
  optionsContainer: { width: canvasSize, gap: 8, marginBottom: 12 },
  ...
  feedbackContainer: { width: canvasSize, alignItems: 'center', gap: 6 },
  ...
  summaryWrapper: { position: 'relative', width: canvasSize, zIndex: 3 },
